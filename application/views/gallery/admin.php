...
<? if ($galleries) { ?>
	...
	<? foreach ($galleries as $gallery) { ?>
		<li class='gallery' id='gallery_<?=$gallery['id']?>'>
			...
			<div class='gallery_links'><a href='<?=$gallery['name']?>/show'>View</a> | <a href='<?=$gallery['name']?>/edit'>Edit</a> | <a class='g_delete_link' href='javascript: void(0);' id='<?=$gallery['id']?>' >Delete</a></div>
		</li>
